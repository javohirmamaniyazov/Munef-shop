...
<div class="body">
    ...
    <div class="slideshow-container">
        <div class="mySlides fade">
            <img src="{{ asset('img/carousel2.jpg') }}" style="width:100%">
        </div>
        <div class="mySlides fade">
            <img src="{{ asset('img/carousel1.jpg') }}" style="width:100%">
        </div>
        <div class="mySlides fade">
            <img src="{{ asset('img/carousel3.jpg') }}" style="width:100%">
        </div>
    </div>
    <br>
    ...
    <div class="products" id="products">
        ...
        <div class="cards">
            @foreach ($products as $product)
                <div class="pcard">
                    <a href="{{ route('products.rusShow', $product->id) }}">
                    ...
                    <div class="for-el">
                        ...
                        <a href="{{ route('products.rusShow', $product->id) }}" class="pcard-cart">
